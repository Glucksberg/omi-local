...
class AppLocalizationsFa extends AppLocalizations {
  ...
  String get enterHotspotCredentials =>
      'اطلاعات اعتباری نقطه اتصال تلفن خود را وارد کنید';
  ...
  String get wifiEnableFailed =>
      'فعال کردن WiFi در دستگاه ناموفق بود. لطفاً دوباره تلاش کنید.';
  ...
  String get enableHotspotMessage =>
      'لطفاً hotspot تلفن خود را فعال کنید و دوباره تلاش کنید.';

  @override
  String get transferStartFailed =>
      'شروع انتقال ناموفق بود. لطفاً دوباره تلاش کنید.';
  ...
  String get invalidWifiCredentials =>
      'اعتبارات WiFi نامعتبر است. تنظیمات hotspot خود را بررسی کنید.';

  @override
  String get wifiConnectionFailed =>
      'اتصال WiFi ناموفق بود. لطفاً دوباره تلاش کنید.';
  ...
  String get premiumMinutesInfo =>
      '1,200 دقیقه premium/ماه. برگه On-Device رونویسی رایگان نامحدود را ارائه می دهد.';
  ...
  String get internetAccessPausedDuringTransfer =>
      'دسترسی به اینترنت در طی انتقال متوقف است';

  @override
  String get chooseTransferMethodDescription =>
      'نحوه انتقال ضبط‌شده‌ها از دستگاه Omi به تلفن خود را انتخاب کنید.';
  ...
  String get lowBatteryAlertBody =>
      'باتری دستگاه شما تقریباً تمام است. وقت شارژ کردن است! 🔋';
