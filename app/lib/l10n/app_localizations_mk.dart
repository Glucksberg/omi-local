...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get freeMinutesMonth =>
      '1,200 слободни минути/месец вклучени. Неограничено со ';
  ...
  String get enterHotspotCredentials =>
      'Внесете ги врите за личната точка на вашиот телефон';
  ...
  String get wifiEnableFailed =>
      'Не успеаше да се активира WiFi на уредот. Моля, обидете се повторно.';

  @override
  String get deviceNoFastTransfer =>
      'Вашиот уред не поддржува брз пренос. Користете Bluetooth наместо тоа.';

  @override
  String get enableHotspotMessage =>
      'Моля, активирајте го хотспотот на вашиот телефон и обидете се повторно.';

  @override
  String get transferStartFailed =>
      'Не успеаше да се почне преносот. Моја, обидете се повторно.';
  ...
  String get invalidWifiCredentials =>
      'Невалидни kredencijali за WiFi. Проверете ги вашите подесувања на хотспот.';

  @override
  String get wifiConnectionFailed =>
      'Врската WiFi неуспеа. Моля, обидете се повторно.';
  ...
  String get internetAccessPausedDuringTransfer =>
      'Пристапот до интернет е паузиран durante трансферот';
  ...
  String get lowBatteryAlertBody =>
      'Вашиот уред има ниска батерија. Време е за полнење! 🔋';
  ...
  String get deviceDoesNotSupportWifiSwitchingToBle =>
      'Уредот не подржува WiFi синхронизација, смена на Bluetooth';
