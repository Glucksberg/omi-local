...
class AppLocalizationsHe extends AppLocalizations {
  ...
  String get enterHotspotCredentials =>
      'הזן את פרטי הנקודה הציבורית של הטלפון שלך';
  ...
  String get deviceNoFastTransfer =>
      'המכשיר שלך אינו תומך בהעברה מהירה. השתמש ב-Bluetooth במקום זאת.';

  @override
  String get enableHotspotMessage =>
      'אנא הפעל את נקודת החום של הטלפון שלך ונסה שוב.';
  ...
  String get invalidWifiCredentials =>
      'אישורי WiFi לא תקפים. בדוק את הגדרות נקודת החום שלך.';
  ...
  String get premiumMinutesInfo =>
      '1,200 דקות פרמיום/חודש. כרטיסייה On-Device מציעה תמלול בחינם ללא הגבלה.';
  ...
  String get internetAccessPausedDuringTransfer =>
      'גישת האינטרנט מושהית במהלך ההעברה';

  @override
  String get chooseTransferMethodDescription =>
      'בחר כיצד יוסברו הקלטות מהתקן Omi שלך לטלפון שלך.';
  ...
  String get lowBatteryAlertBody =>
      'ההתקן שלך נמצא בסוללה נמוכה. הגיע הזמן לטעינה מחדש! 🔋';
  ...
  String get deviceDoesNotSupportWifiSwitchingToBle =>
      'ההתקן אינו תומך בסנכרון WiFi, מעבר ל-Bluetooth';
