...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get enterHotspotCredentials =>
      'Унесите акредитиве топле тачке вашег телефона';
  ...
  String get wifiEnableFailed =>
      'Грешка при омогућавању WiFi-ја на уређају. Покушајте поново.';

  @override
  String get deviceNoFastTransfer =>
      'Ваш уређај не подржава брз пренос. Користите Bluetooth уместо тога.';

  @override
  String get enableHotspotMessage =>
      'Омогућите точку приступа телефона и покушајте поново.';

  @override
  String get transferStartFailed =>
      'Грешка при покретању преноса. Покушајте поново.';
  ...
  String get invalidWifiCredentials =>
      'Неважећи учитељи за WiFi. Проверите подешавања точке приступа.';

  @override
  String get wifiConnectionFailed =>
      'Грешка при повезивању са WiFi-јем. Покушајте поново.';
  ...
  String get internetAccessPausedDuringTransfer =>
      'Приступ интернету је паузиран током преноса';
  ...
  String get lowBatteryAlertBody =>
      'Батерија вашег уређаја је скоро празна. Време је за пуњење! 🔋';
